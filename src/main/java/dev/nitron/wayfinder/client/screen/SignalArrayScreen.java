...
import dev.nitron.wayfinder.client.screen.widgets.TextFieldWidgetColorable;
import dev.nitron.wayfinder.client.screen.widgets.ToggleableWidget;
...
public class SignalArrayScreen extends Screen {
    ...
    private TextFieldWidgetColorable nameWidget;
    private TextFieldWidgetColorable redWidget;
    private TextFieldWidgetColorable greenWidget;
    private TextFieldWidgetColorable blueWidget;
    ...
    public void renderBackground(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(
                ...
                context.getScaledWindowWidth() / 2 - (184 / 2),
                context.getScaledWindowHeight() / 2 - ((65) / 2) - 78,
                0,
                0,
                184,
                150,
    ...
    protected void init() {
        ...
        typeField = new TextWidget(x - 65, y - 5, 20, 20, Text.literal(String.valueOf(blockEntity.type)).withColor(0xf4e063), client.textRenderer);
        this.addDrawableChild(typeField);

        x += 2;
        y += 5;

        this.nameWidget = new TextFieldWidgetColorable(client.textRenderer, x - 23, y - 14, 100, 17, Text.literal("Signal"), 0xFFf4e063);
        ...
        this.redWidget = new TextFieldWidgetColorable(client.textRenderer, x - 23, y + 4, 26, 17, Text.literal("Signal"), 0xFFf4e063);
        ...
        this.greenWidget = new TextFieldWidgetColorable(client.textRenderer, x - 23 + 37, y + 4, 26, 17, Text.literal("Signal"), 0xFFf4e063);
        ...
        this.blueWidget = new TextFieldWidgetColorable(client.textRenderer, x - 23 + 37 + 37, y + 4, 26, 17, Text.literal("Signal"), 0xFFf4e063);
    ...
    private void cycleType() {
        ...
        this.typeField.setMessage(Text.literal(String.valueOf(value)).withColor(0xf4e063));
    }
