...
public record SignalArrayC2SPayload(String name, Vector3f color, BlockPos pos) implements CustomPayload {
    ...
    public static void send(String name, Vec3i var, BlockPos pos){
        Vector3f converted = new Vector3f(var.getX(), var.getY(), var.getZ());
        ClientPlayNetworking.send(new SignalArrayC2SPayload(name, converted, pos));
    }
    ...
    public static class Receiver implements ServerPlayNetworking.PlayPayloadHandler<SignalArrayC2SPayload> {
        ...
        public void receive(SignalArrayC2SPayload signalArrayC2SPayload, ServerPlayNetworking.Context context) {
            ...
            if (blockEntity instanceof SignalArrayBlockEntity signalArrayBlockEntity){
                signalArrayBlockEntity.update(signalArrayC2SPayload.name, new Vec3i((int) signalArrayC2SPayload.color.x, (int) signalArrayC2SPayload.color.y, (int) signalArrayC2SPayload.color.z));
            }
        }
    }
}
